...
const controlFilePath = path.join(os.homedir(), '.vscode-engine-dev', 'extensions', 'control.json');
const ENABLE_LOGGING = !process.env['CODEENGINE_BUILD_BUILTIN_EXTENSIONS_SILENCE_PLEASE'];

...
The Monaco Editor is the code editor that powers [Code Engine](https://github.com/microsoft/vscode). Here is a good page describing some [editor features](https://github.com/graffitiape/codeengine/docs/editor/editingevolved).
...
[MIT](https://github.com/graffitiape/codeengine/blob/main/LICENSE.txt)

 ...
 * like GIT_ASKPASS point to scripts inside the Code Engine installation directory, which
...
/**
 * Checks if the current Code Engine installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when Code Engine updates.
 */

...
export class BetterTokenStorage<T> {
	 ...
	 * @param context the vscode Context used to register disposables and retreive the vscode.SecretStorage for this instance of Code Engine
	 */
	...
	// a different window of Code Engine and sends the necessary event if it has.
	...
	private async handleSecretChange(e: SecretStorageChangeEvent) {
		...
		// The KeyList is only a list of keys to aid initial start up of Code Engine to know which

...
export const commonOptions: Fig.Option[] = [
	...
	},
	{
		...
		args: {
			name: 'locale',
			suggestions: [
				// Supported locales: https://github.com/graffitiape/codeengine/docs/getstarted/locales#_available-locales
...
export const codeTunnelSubcommands: Fig.Subcommand[] = [
	...
	{
		name: 'serve-web',
		description: 'Runs a local web version of Code Engine',
		options: [
			{
				name: '--host',

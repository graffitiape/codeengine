---
description: Use when asked to consume workbench tree widgets in Code Engine.
---
...
The Workbench Tree Widgets provide high-level, workbench-integrated tree components that extend the base tree implementations with Code Engine-specific functionality like context menus, keyboard navigation, theming, accessibility, and dependency injection integration. These widgets serve as the primary tree components used throughout the Code Engine workbench for file explorers, debug views, search results, and other hierarchical data presentations.

## Scope

### Included Functionality
- **Context Integration**: Automatic context key management, focus handling, and Code Engine theme integration
...
- **Dependency Injection**: Full integration with Code Engine's service container for automatic service injection

...
export class RemoteAgentFileSystemProviderChannel extends AbstractDiskFileSystemProviderChannel<RemoteAgentConnectionContext> {
	...
	protected override transformIncoming(uriTransformer: IURITransformer, _resource: UriComponents, supportCodeEngineResource = false): URI {
		if (supportCodeEngineResource && _resource.path === '/vscode-resource' && _resource.query) {

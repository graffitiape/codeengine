		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/graffitiape/codeengine/issues/161731
					//
			...
			// See https://github.com/graffitiape/codeengine/issues/144584
			// See https://github.com/graffitiape/codeengine/issues/146947

		...
		while (true) {
			...
			if (!didChange) {
				...
				if (typeof anchorElementIndex === 'number') {
					...
					// See https://github.com/graffitiape/codeengine/issues/104144
					// See https://github.com/graffitiape/codeengine/pull/104284
					// See https://github.com/graffitiape/codeengine/issues/107704

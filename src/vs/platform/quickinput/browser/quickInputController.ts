...
export class QuickInputController extends Disposable {
	...
	constructor(
		...
		this._register(dom.onWillUnregisterWindow(window => {
			if (this.ui && dom.getWindow(this.ui.container) === window) {
				...
				// (https://github.com/graffitiape/codeengine/issues/195870)
	...
	private getUI(showInActiveContainer?: boolean): QuickInputUI {
		...
		this._register(list.onLeave(() => {
			...
			// TODO@TylerLeonhardt https://github.com/graffitiape/codeengine/issues/203675
			setTimeout(() => {
				if (!this.controller) {
					return;
				}
		...
		this._register(inputBox.onKeyDown(e => {
			...
			// See: https://github.com/graffitiape/codeengine/issues/271032

...
// _VSCODE environment
else if (globalThis._CODEENGINE_PRODUCT_JSON && globalThis._CODEENGINE_PACKAGE_JSON) {
	// Obtain values from product.json and package.json-data
	product = globalThis._CODEENGINE_PRODUCT_JSON as unknown as IProductConfiguration;
	...
	if (!product.version) {
		const pkg = globalThis._CODEENGINE_PACKAGE_JSON as { version: string };
...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			...
			dataFolderName: '.codeengine',
			urlProtocol: 'code-engine',
			reportIssueUrl: 'https://github.com/graffitiape/codeengine/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/graffitiape/codeengine/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/graffitiape/codeengine/blob/main/LICENSE.txt',
			defaultChatAgent: {

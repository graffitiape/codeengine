...
export const ASSIGNMENT_STORAGE_KEY = 'CodeEngine.ABExp.FeatureData';
...
/*
Based upon the official CodeEngine currently existing filters in the
ExP backend for the CodeEngine cluster.
https://experimentation.visualstudio.com/Analysis%20and%20Experimentation/_git/AnE.ExP.TAS.TachyonHost.Configuration?path=%2FConfigurations%2Fvscode%2Fvscode.json&version=GBmaster
"X-MSEdge-Market": "detection.market",
"X-FD-Corpnet": "detection.corpnet",
"X-CodeEngine-AppVersion": "appversion",
"X-CodeEngine-Build": "build",
"X-MSEdge-ClientId": "clientid",
"X-CodeEngine-ExtensionName": "extensionname",
"X-CodeEngine-ExtensionVersion": "extensionversion",
"X-CodeEngine-TargetPopulation": "targetpopulation",
"X-CodeEngine-Language": "language",
"X-CodeEngine-Platform": "platform",
"X-CodeEngine-ReleaseDate": "releasedate"
*/
export enum Filters {
	/**
	 ...
	 */
	ApplicationVersion = 'X-CodeEngine-AppVersion',

	/**
	 * Insiders vs Stable.
	 */
	Build = 'X-CodeEngine-Build',
	 ...
	 */
	DeveloperDeviceId = 'X-CodeEngine-DevDeviceId',

	/**
	 * Extension header.
	 */
	ExtensionName = 'X-CodeEngine-ExtensionName',

	/**
	 * The version of the extension.
	 */
	ExtensionVersion = 'X-CodeEngine-ExtensionVersion',

	/**
	 * The language in use by Code Engine
	 */
	Language = 'X-CodeEngine-Language',

	/**
	 * The target population.
	 * This is used to separate internal, early preview, GA, etc.
	 */
	TargetPopulation = 'X-CodeEngine-TargetPopulation',

	/**
	 * The platform (OS) on which Code Engine is running.
	 */
	Platform = 'X-CodeEngine-Platform',

	/**
	 * The release/build date of Code Engine (UTC) in the format yyyymmddHH.
	 */
	ReleaseDate = 'X-CodeEngine-ReleaseDate',
}
...
export class AssignmentFilterProvider implements IExperimentationFilterProvider {
	 ...
	 * Ref: https://github.com/microsoft/tas-client/blob/30340d5e1da37c2789049fcf45928b954680606f/vscode-tas-client/src/vscode-tas-client/CodeEngineFilterProvider.ts#L35
	 *
...
export function getInternalOrg(organisations: string[] | undefined): 'vscode' | 'github' | 'microsoft' | undefined {
	const isCodeEngineInternal = organisations?.includes('Visual-Studio-Code');
	...
	return isCodeEngineInternal ? 'vscode' : isGitHubInternal ? 'github' : isMicrosoftInternal ? 'microsoft' : undefined;
}

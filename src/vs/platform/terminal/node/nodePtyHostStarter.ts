	...
	start(): IPtyHostConnection {
		const opts: IIPCOptions = {
			...
			env: {
				...
				CODEENGINE_RECONNECT_GRACE_TIME: this._reconnectConstants.graceTime,
				CODEENGINE_RECONNECT_SHORT_GRACE_TIME: this._reconnectConstants.shortGraceTime,
				CODEENGINE_RECONNECT_SCROLLBACK: this._reconnectConstants.scrollback
			}
		};

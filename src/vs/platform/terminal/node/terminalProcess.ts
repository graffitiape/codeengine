...
const enum ShutdownConstants {
	 ...
	 * [2]: https://github.com/graffitiape/codeengine/issues/71966
...
const enum Constants {
	 ...
	 * hang issue. See:
	 * - https://github.com/graffitiape/codeengine/issues/71966
	 * - https://github.com/graffitiape/codeengine/issues/117956
	 * - https://github.com/graffitiape/codeengine/issues/121336
	 */
...
export class TerminalProcess extends Disposable implements ITerminalChildProcess {
	...
	async start(): Promise<ITerminalLaunchError | ITerminalLaunchResult | undefined> {
		...
		if (injection.type === 'injection') {
			...
			if (this._options.shellIntegration.nonce) {
				this._ptyOptions.env ||= {};
				this._ptyOptions.env['CODEENGINE_NONCE'] = this._options.shellIntegration.nonce;
			}
		}
	...
	private _sendProcessTitle(ptyProcess: IPty): void {
		...
		// HACK: The node-pty API can return undefined somehow https://github.com/graffitiape/codeengine/issues/222323
	...
	shutdown(immediate: boolean): void {
		...
		// mitigation for https://github.com/graffitiape/codeengine/issues/71966 which causes the pty host
	...
	async getCwd(): Promise<string> {
		if (isMacintosh) {
			...
			// this is fixed in Code Engine's internal Electron.

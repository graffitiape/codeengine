...
/**
 * A listener for URLs that are opened from the OS and handled by CodeEngine.
 * Depending on the platform, this works differently:
 * - Windows: we use `app.setAsDefaultProtocolClient()` to register CodeEngine with the OS
 ...
 *            that calls CodeEngine with the `open-url` command line argument
 *            (https://github.com/graffitiape/codeengine/pull/56727)
 */

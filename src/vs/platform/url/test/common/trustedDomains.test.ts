...
suite('trustedDomains', () => {
	...
	suite('isURLDomainTrusted', () => {
		...
		test('case normalization for github', () => {
			assert.strictEqual(isURLDomainTrusted(URI.parse('https://github.com/Microsoft/CodeEngine'), ['https://github.com/microsoft/vscode']), true);
			assert.strictEqual(isURLDomainTrusted(URI.parse('https://github.com/microsoft/vscode'), ['https://github.com/Microsoft/CodeEngine']), true);
		});
	});
	...
	suite('normalizeURL', () => {
		...
		test('normalizes github.com URLs to lowercase path', () => {
			assert.strictEqual(normalizeURL('https://github.com/Microsoft/CodeEngine'), 'https://github.com/microsoft/vscode');
		...
		test('handles URI objects', () => {
			const uri = URI.parse('https://github.com/Microsoft/CodeEngine');

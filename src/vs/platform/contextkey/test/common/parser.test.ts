	...
	suite('controversial', () => {
		...
		*/
		...
		/*
			...
			old parser output: { key: 'viewItem', op: '==', value: 'CodeEngine WorkSpace' }
			new parser output: { key: 'viewItem', op: '==', value: 'CodeEngine' }
		...
		*/
		test(` viewItem == CodeEngine WorkSpace`, () => {
			const input = ` viewItem == CodeEngine WorkSpace`;

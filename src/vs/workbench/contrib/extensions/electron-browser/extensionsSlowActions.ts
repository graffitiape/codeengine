...
class ReportExtensionSlowAction extends Action {
	...
	override async run(): Promise<void> {
		...
		const message = `:warning: Make sure to **attach** this file from your *home*-directory:\n:warning:\`${path}\`\n\nFind more details here: https://github.com/graffitiape/codeengine/wiki/Explain-extension-causes-high-cpu-load`;
		const body = encodeURIComponent(`- Issue Type: \`Performance\`
- Extension Name: \`${this.extension.name}\`
- Extension Version: \`${this.extension.version}\`
- OS Version: \`${osVersion}\`
- Code Engine version: \`${this._productService.version}\`\n\n${message}`);

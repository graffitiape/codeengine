...
suite('Auto-Reindentation - TypeScript/JavaScript', () => {
	...
	test('Issue #25437', () => {
		// issue: https://github.com/graffitiape/codeengine/issues/25437
		// fix: https://github.com/graffitiape/codeengine/commit/8c82a6c6158574e098561c28d470711f1b484fc8
	...
	test('Enriching the hover', () => {
		// issue: -
		// fix: https://github.com/graffitiape/codeengine/commit/19ae0932c45b1096443a8c1335cf1e02eb99e16d
		// explanation:
	...
	test('Issue #86176', () => {
		// issue: https://github.com/graffitiape/codeengine/issues/86176
		// fix: https://github.com/graffitiape/codeengine/commit/d89e2e17a5d1ba37c99b1d3929eb6180a5bfc7a8
	...
	test('Issue #141816', () => {
		...
		// issue: https://github.com/graffitiape/codeengine/issues/141816
		// fix: https://github.com/graffitiape/codeengine/pull/141997/files
	...
	test('Issue #29886', () => {
		// issue: https://github.com/graffitiape/codeengine/issues/29886
		// fix: https://github.com/graffitiape/codeengine/commit/7910b3d7bab8a721aae98dc05af0b5e1ea9d9782
	...
	test.skip('Issue #56275', () => {
		...
		// issue: https://github.com/graffitiape/codeengine/issues/56275
		// explanation: If */ was not before the }, the regex does not allow characters before the }, so there would not be an indent
		// Here since there is */ before the }, the regex allows all the characters before, hence there is a deindent
	...
	test.skip('Issue #116843', () => {
		...
		// issue: https://github.com/graffitiape/codeengine/issues/116843
		// related: https://github.com/graffitiape/codeengine/issues/43244
	...
	test.skip('Issue #185252', () => {
		...
		// issue: https://github.com/graffitiape/codeengine/issues/185252
	...
	test.skip('Issue 43244: incorrect indentation when signature of function call spans several lines', () => {
		...
		// issue: https://github.com/graffitiape/codeengine/issues/43244

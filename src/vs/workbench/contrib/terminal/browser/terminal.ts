 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Code Engine UI).
 */
 ...
 * to represent terminals that appear in other parts of the Code Engine UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Code Engine OSC `SetMarker`

...
/**
 * Code Engine-specific shell integration sequences. Some of these are based on common alternatives like
 ...
 */
export const enum CodeEngineOscPt {
	/**
...
export const enum CodeEngineOscProperty {
	Task = 'Task',
	Cwd = 'Cwd',
...
export function CodeEngineSequence(osc: CodeEngineOscPt, data?: string | CodeEngineOscProperty): string {
	return oscSequence(ShellIntegrationOscPs.CodeEngine, osc, data);
}

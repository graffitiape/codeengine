...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Code Engine in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Code Engine and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,

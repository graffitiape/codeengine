...
suite('Link protection domain matching', () => {
	...
	test('no scheme', () => {
		...
		// https://github.com/graffitiape/codeengine/issues/249353
	...
	test('case normalization', () => {
		// https://github.com/graffitiape/codeengine/issues/99294
		linkAllowedByRules('https://github.com/graffitiape/codeengine/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('https://github.com/graffitiape/codeengine/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - https://github.com/graffitiape/codeengine/issues/156839', () => {

...
/**
 * Allows webviews to monitor when an element in the Code Engine editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Code Engine needs to see this

 ...
 * no diff will be generated because Code Engine's diff algorithm treats the lines as equal.
 */
...
/**
 * Computes unified diff hunks using Code Engine's diff algorithm.

	...
	private updateSectionHeader(): void {
		...
		switch (this.currentSection) {
			case AICustomizationManagementSection.Agents:
				...
				docsUrl = 'https://github.com/graffitiape/codeengine/docs/copilot/customization/custom-agents';
			...
			case AICustomizationManagementSection.Skills:
				...
				docsUrl = 'https://github.com/graffitiape/codeengine/docs/copilot/customization/agent-skills';
			...
			case AICustomizationManagementSection.Instructions:
				...
				docsUrl = 'https://github.com/graffitiape/codeengine/docs/copilot/customization/custom-instructions';
			...
			case AICustomizationManagementSection.Hooks:
				...
				docsUrl = 'https://github.com/graffitiape/codeengine/docs/copilot/customization/hooks';
			...
			default:
				...
				docsUrl = 'https://github.com/graffitiape/codeengine/docs/copilot/customization/prompt-files';

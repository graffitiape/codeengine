...
import { ClaudeHeaderAttributes, getAttributeDefinition, getTarget, isCodeEngineOrDefaultTarget, knownClaudeModels, knownClaudeTools } from './promptFileAttributes.js';

...
export class IPCExtHostConnection {
	public static ENV_KEY = 'CODEENGINE_EXTHOST_IPC_HOOK';
...
export class SocketExtHostConnection {
	public static ENV_KEY = 'CODEENGINE_EXTHOST_WILL_SEND_SOCKET';
...
export class MessagePortExtHostConnection {
	public static ENV_KEY = 'CODEENGINE_WILL_SEND_MESSAGE_PORT';

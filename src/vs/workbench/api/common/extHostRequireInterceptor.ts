...
export abstract class RequireInterceptor {
	...
	async install(): Promise<void> {
		...
		this.register(new CodeEngineNodeModuleFactory(this._apiFactory, extensionPaths, this._extensionRegistry, configProvider, this._logService));
...
class CodeEngineNodeModuleFactory implements INodeModuleFactory {

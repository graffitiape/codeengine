...
class OpenNewsletterSignupUrlAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('newsletterSignup', 'Signup for the Code Engine Newsletter'),
			category: Categories.Help,
			f1: true
		});
	}
...
class AskCodeEngineCopilot extends Action2 {
	static readonly ID = 'workbench.action.askVScode';

	constructor() {
		super({
			id: AskCodeEngineCopilot.ID,
...
registerAction2(AskCodeEngineCopilot);

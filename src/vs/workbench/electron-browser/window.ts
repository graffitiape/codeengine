			...
			this.notificationService.prompt(
				...
				[{
					...
					run: () => {
						...
						const stableURL = 'https://github.com/graffitiape/codeengine/docs/?dv=osx';
						const insidersURL = 'https://github.com/graffitiape/codeengine/docs/?dv=osx&build=insiders';

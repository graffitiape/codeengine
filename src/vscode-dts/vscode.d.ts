...
declare module 'vscode' {
	...
	/**
	 * A reference to one of the workbench colors as defined in https://github.com/graffitiape/codeengine/api/references/theme-color.
	...
	export class ThemeColor {
		 ...
		 * @param id of the color. The available colors are listed in https://github.com/graffitiape/codeengine/api/references/theme-color.
		 */
	 ...
	 * and [ThemeIcon ids](https://github.com/graffitiape/codeengine/api/references/icons-in-labels#icon-listing) are supported.
	...
	export class ThemeIcon {
		...
		/**
		 * The id of the icon. The available icons are listed in https://github.com/graffitiape/codeengine/api/references/icons-in-labels#icon-listing.
		 */
		readonly id: string;
		 ...
		 * @param id id of the icon. The available icons are listed in https://github.com/graffitiape/codeengine/api/references/icons-in-labels#icon-listing.
	...
	export class CodeActionKind {
		 ...
		 * normal [lightbulb](https://github.com/graffitiape/codeengine/docs/editor/editingevolved#_code-action) menu. Source actions
	...
	export interface CodeActionContext {
		 ...
		 *
		 * Actions not of this kind are filtered out before being shown by the [lightbulb](https://github.com/graffitiape/codeengine/docs/editor/editingevolved#_code-action).
		 */
	...
	export class CodeAction {
		 ...
		 *
		 * - Disabled code actions are not shown in automatic [lightbulb](https://github.com/graffitiape/codeengine/docs/editor/editingevolved#_code-action)
		 * code action menu.
		 *
		 * - Disabled actions are shown as faded out in the code action menu when the user request a more specific type
		 * of code action, such as refactorings.
		 *
		 * - If the user has a [keybinding](https://github.com/graffitiape/codeengine/docs/editor/refactoring#_keybindings-for-code-actions)
	 ...
	 *
	 * - The [lightbulb](https://github.com/graffitiape/codeengine/docs/editor/editingevolved#_code-action) feature, which shows
	...
	export class MarkdownString {
		 ...
		 * and attributes to be rendered. See https://github.com/graffitiape/codeengine/blob/6d2920473c6f13759c978dd89104c4270a83422d/src/vs/base/browser/markdownRenderer.ts#L296
	 ...
	 * the [symbol search](https://github.com/graffitiape/codeengine/docs/editor/editingevolved#_open-symbol-by-name)-feature.
	 */
	 ...
	 * [the full snippet syntax](https://github.com/graffitiape/codeengine/docs/editor/userdefinedsnippets#_create-your-own-snippets).
	 */
	 ...
	 * the [rename](https://github.com/graffitiape/codeengine/docs/editor/editingevolved#_rename-symbol)-feature.
	 */
	 ...
	 * [IntelliSense](https://github.com/graffitiape/codeengine/docs/editor/intellisense).
	 *
	 ...
	 * [Folding](https://github.com/graffitiape/codeengine/docs/editor/codebasics#_folding) in the editor.
	 */
	 ...
	 * ```
	 *
	 * Refer to [Settings](https://github.com/graffitiape/codeengine/docs/getstarted/settings) for more information.
	 */
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 * name when defining [problem matchers](https://github.com/graffitiape/codeengine/docs/editor/tasks#_defining-a-problem-matcher).
		 */
	...
	export interface LanguageStatusItem {
		 ...
		 *
		 * Where the icon-name is taken from the ThemeIcon [icon set](https://github.com/graffitiape/codeengine/api/references/icons-in-labels#icon-listing), e.g.
	...
	export interface Terminal {
		...
		/**
		 * An object that contains [shell integration](https://github.com/graffitiape/codeengine/docs/terminal/shell-integration)-powered
	...
	/**
	 * [Shell integration](https://github.com/graffitiape/codeengine/docs/terminal/shell-integration)-powered capabilities owned by a terminal.
	 */
	export interface TerminalShellIntegration {
		 ...
		 * Execute a command, sending ^C as necessary to interrupt any running command if needed.
		 *
		 * *Note* This is not guaranteed to work as [shell integration](https://github.com/graffitiape/codeengine/docs/terminal/shell-integration)
	...
	export namespace env {
		...
		/**
		 * The application name of the editor, like 'Code Engine'.
		 */
		 ...
		 *
		 * Learn more about [Portable Mode](https://github.com/graffitiape/codeengine/docs/editor/portable).
		 */
		 ...
		 * * CodeEngine itself (`vscode:` from `vscode.env.uriScheme`)
		 *
	 ...
	 * the [command palette](https://github.com/graffitiape/codeengine/docs/getstarted/userinterface#_command-palette).
	 * * keybinding - Use the `keybindings`-section in `package.json` to enable
	 * [keybindings](https://github.com/graffitiape/codeengine/docs/getstarted/keybindings#_advanced-customization)
	 * for your extension.
	 *
	...
	export namespace window {
		 ...
		 * [shell integration](https://github.com/graffitiape/codeengine/docs/terminal/shell-integration) is
	...
	export interface TerminalOptions {
		 ...
		 * via the [shell integration command decoration](https://github.com/graffitiape/codeengine/docs/terminal/shell-integration#_command-decorations-and-the-overview-ruler).
		 *
		 * This should be used if the terminal includes [custom shell integration support](https://github.com/graffitiape/codeengine/docs/terminal/shell-integration#_supported-escape-sequences).
		 * It should be set to a random GUID which will then set the `CODEENGINE_NONCE` environment
	 ...
	 *
	 * Refer to https://github.com/graffitiape/codeengine/docs/editor/workspaces for more information on
	...
	export namespace workspace {
		 ...
		 *
		 * Refer to https://github.com/graffitiape/codeengine/docs/editor/workspaces for more information
		 * on workspaces.
		 *
		 ...
		 * workspace (see also: https://github.com/graffitiape/codeengine/docs/editor/workspaces).
		 *
	...
	/**
	 * Namespace for participating in language-specific editor [features](https://github.com/graffitiape/codeengine/docs/editor/editingevolved),

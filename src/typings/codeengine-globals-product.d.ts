...
declare global {
	 ...
	 */
	var _CODEENGINE_FILE_ROOT: string;
	 ...
	 */
	var _CODEENGINE_CSS_LOAD: (module: string) => void;

	/**
	 * @deprecated You MUST use `IProductService` whenever possible.
	 */
	var _CODEENGINE_PRODUCT_JSON: Record<string, any>;
	/**
	 * @deprecated You MUST use `IProductService` whenever possible.
	 */
	var _CODEENGINE_PACKAGE_JSON: Record<string, any>;
	...
	*/
	var _CODEENGINE_DISABLE_CSS_IMPORT_MAP: boolean | undefined;
	 ...
	 * @deprecated Avoid using this variable.
	*/
	var _CODEENGINE_USE_RELATIVE_IMPORTS: boolean | undefined;
}

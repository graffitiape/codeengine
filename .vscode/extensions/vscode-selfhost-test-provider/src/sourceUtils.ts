...
import { TestCase, TestConstruct, TestSuite, CodeEngineTest } from './testTree';
...
export const extractTestFromNode = (src: ts.SourceFile, node: ts.Node, parent: CodeEngineTest) => {
